      ...
      <div className="max-w-mobile mx-auto sm:max-w-lg md:max-w-2xl lg:max-w-4xl xl:max-w-5xl">
        <section>
          ...
          <div className="flex justify-start gap-x-6">
            <Link href="https://www.linkedin.com/in/baokhanhle/" target="_blank"><BsLinkedin className="icon" size="36px" alt="LinkedIn" /></Link>
            <Link href="https://github.com/bxokhxnhle" target="_blank"><BsGithub className="icon" size="36px" alt="GitHub" /></Link>
            <Link href="mailto:khanh.le@uwaterloo.ca"><BsFillEnvelopeAtFill className="icon" size="36px" alt="Email" /></Link>
            <Link href="https://drive.google.com/file/d/1Um-_rE17upYQryH7cFDOwAjfnY5Er44-/view?usp=sharing" target="_blank"><BsFileEarmarkArrowDownFill className="icon" size="36px" alt="Resume" /></Link>
          </div>
